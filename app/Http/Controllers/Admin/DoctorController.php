...
class DoctorController extends Controller
{
    ...
    public function sendingDoctor(Request $request)
    {
        $validations = \Validator::make($request->all(), [
            'doctor_id' => 'required',
            'inquiry_id' => 'required',
        ...
        event(new \App\Events\EventAfterSendingToDoctor($doctors, $inquiry));

        return response()->json(['status' => 'success', 'message' => 'Doctor has been sent!'], 200);
    }
